...
START_TEST(fabs_test_6) { ck_assert_ldouble_nan(s21_fabs(NAN)); }
END_TEST

START_TEST(fabs_test_7) { ck_assert_ldouble_infinite(s21_fabs(max_inf)); }
END_TEST

START_TEST(fabs_test_8) {
  ck_assert_ldouble_eq_tol(s21_fabs(-9519359135915.53151413431),
                           fabs(-9519359135915.53151413431), accuracy);
}
END_TEST
...
START_TEST(fabs_test_10) { ck_assert_ldouble_eq(s21_fabs(15.01), fabs(15.01)); }
END_TEST
