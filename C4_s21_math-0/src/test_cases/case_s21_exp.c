...
END_TEST
START_TEST(exp_test_13) { ck_assert_ldouble_infinite(s21_exp(max_inf)); }
...
START_TEST(exp_test_15) { ck_assert_ldouble_nan(s21_exp(max_nan)); }

END_TEST

START_TEST(exp_test_16) { ck_assert_ldouble_nan(s21_exp(min_nan)); }
