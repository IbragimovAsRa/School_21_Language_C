...
START_TEST(tan_test_1) { ck_assert_ldouble_nan(s21_cos(max_inf)); }
END_TEST

START_TEST(tan_test_2) { ck_assert_ldouble_nan(s21_cos(min_inf)); }
END_TEST

START_TEST(tan_test_3) { ck_assert_ldouble_nan(s21_cos(max_nan)); }
END_TEST

START_TEST(tan_test_4) { ck_assert_ldouble_nan(s21_cos(min_nan)); }
END_TEST
...
START_TEST(tan_test_7) { ck_assert_ldouble_eq_tol(s21_tan(-1), tan(-1), 1e-6); }
END_TEST

START_TEST(tan_test_8) { ck_assert_ldouble_eq_tol(s21_tan(1), tan(1), 1e-6); }
END_TEST
...
START_TEST(tan_test_11) { ck_assert_ldouble_eq_tol(s21_tan(0), tan(0), 1e-6); }
END_TEST
