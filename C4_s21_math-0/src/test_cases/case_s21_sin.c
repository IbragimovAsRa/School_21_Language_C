...
START_TEST(sin_test_1) { ck_assert_ldouble_nan(s21_sin(max_inf)); }

END_TEST

START_TEST(sin_test_2) { ck_assert_ldouble_nan(s21_sin(min_inf)); }

END_TEST

START_TEST(sin_test_3) { ck_assert_ldouble_nan(s21_sin(max_nan)); }

END_TEST

START_TEST(sin_test_4) { ck_assert_ldouble_nan(s21_sin(min_nan)); }
...
START_TEST(sin_test_7) { ck_assert_ldouble_eq_tol(s21_sin(-1), sin(-1), 1e-6); }

END_TEST

START_TEST(sin_test_8) { ck_assert_ldouble_eq_tol(s21_sin(1), sin(1), 1e-6); }
...
START_TEST(sin_test_11) { ck_assert_ldouble_eq_tol(s21_sin(0), sin(0), 1e-6); }
