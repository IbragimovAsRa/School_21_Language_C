...
START_TEST(acos_test_1) { ck_assert_ldouble_nan(s21_asin(max_inf)); }
END_TEST

START_TEST(acos_test_2) { ck_assert_ldouble_nan(s21_asin(min_inf)); }

END_TEST

START_TEST(acos_test_3) { ck_assert_ldouble_nan(s21_asin(max_nan)); }

END_TEST

START_TEST(acos_test_4) { ck_assert_ldouble_nan(s21_asin(min_nan)); }
...
START_TEST(acos_test_9) { ck_assert_ldouble_nan(s21_asin(1.1)); }
...
START_TEST(acos_test_16) { ck_assert_ldouble_nan(s21_acos(12345)); }
