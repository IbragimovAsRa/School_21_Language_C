...
START_TEST(ceil_test_3) { ck_assert_ldouble_nan(s21_ceil(max_nan)); }

END_TEST

START_TEST(ceil_test_4) { ck_assert_ldouble_nan(s21_ceil(min_nan)); }
...
START_TEST(ceil_test_7) { ck_assert_ldouble_eq(s21_ceil(0.45), ceil(0.45)); }
