...
START_TEST(floor_test_6) { ck_assert_ldouble_infinite(s21_floor(INFINITY)); }
END_TEST

START_TEST(floor_test_7) { ck_assert_ldouble_nan(s21_floor(NAN)); }
END_TEST
...
START_TEST(floor_test_12) { ck_assert_ldouble_nan(s21_floor(NAN)); }
END_TEST
