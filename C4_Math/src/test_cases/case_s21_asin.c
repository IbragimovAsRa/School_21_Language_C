...
START_TEST(asin_test_1) { ck_assert_ldouble_nan(s21_asin(max_inf)); }
END_TEST

START_TEST(asin_test_2) { ck_assert_ldouble_nan(s21_asin(min_inf)); }
END_TEST

START_TEST(asin_test_3) { ck_assert_ldouble_nan(s21_asin(max_nan)); }
END_TEST

START_TEST(asin_test_4) { ck_assert_ldouble_nan(s21_asin(min_nan)); }
END_TEST
...
START_TEST(asin_test_9) { ck_assert_ldouble_nan(s21_asin(1.1)); }
END_TEST
...
START_TEST(asin_test_16) { ck_assert_ldouble_nan(s21_asin(12345)); }
END_TEST

Suite *get_suite_s21_asin() {
  Suite *s = suite_create("s21_asin suite ");
  TCase *tc = tcase_create("s21_asin test case");
