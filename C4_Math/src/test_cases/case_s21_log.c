...
END_TEST
START_TEST(log_test_2) { ck_assert_ldouble_nan(s21_log(-0.5)); }
END_TEST
...
END_TEST
START_TEST(log_test_5) { ck_assert_ldouble_infinite(s21_log(0)); }
END_TEST
START_TEST(log_test_6) { ck_assert_ldouble_infinite(s21_log(-0)); }
END_TEST
START_TEST(log_test_7) {
  ck_assert_ldouble_eq_tol(s21_log(5.123456789123), log(5.123456789123),
                           accuracy);
}
END_TEST
...
END_TEST
START_TEST(log_test_10) { ck_assert_ldouble_infinite(s21_log(max_inf)); }
END_TEST
START_TEST(log_test_11) { ck_assert_ldouble_nan(s21_log(min_inf)); }
END_TEST
START_TEST(log_test_12) { ck_assert_ldouble_nan(s21_log(max_nan)); }
END_TEST
START_TEST(log_test_13) { ck_assert_ldouble_nan(s21_log(min_nan)); }
END_TEST
