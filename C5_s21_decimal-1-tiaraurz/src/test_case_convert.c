...
// в памяти хранится как 758.320984
...
END_TEST
START_TEST(convert_test_8) // тест провален, не сработало округление------------------------------------------------------
{
...
get_suite_convert()
{
    ...
    tcase_add_test(tc, convert_test_56);
    tcase_add_test(tc, convert_test_57);
